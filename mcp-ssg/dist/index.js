...
const EthicsModule = {
    ...
    weightedRisk(ld) {
        return ((ld.totalDissipation / CAP_DISSIPATION) * W_DISSIPATION +
...
export class MCPSSGServer {
    ...
    constructor() {
        this.server = new Server({ name: "mcp-ssg-airgap", version: "1.3.0-anticipatory-field" }, { capabilities: { tools: {} } });
